...
earth_vol = 1.08321e12
planet_radius = float(input("Введите радиус случайной планеты: "))
planet_vol = (4/3) * math.pi * math.pow(planet_radius, 3)
ratio = earth_vol / planet_vol
if ratio > 1:
    print(f"Объём планеты Земля больше в {ratio:.3f} раз")
else:
    print(f"Объём планеты Земля меньше в (1/{ratio:.3f}) = {1/ratio:.3f} раз")
